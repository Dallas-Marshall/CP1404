...
for i in range(0, 101, 50):
    print("Number is {:3}".format(i))

# Question 1
# the function returned a random integer between 5 and 20, lowest number possible was 5, while biggest was 20.

# Question 2
# the function returned a value within the start/stop conditions and only those that were in the step size specified.
# largest possible number being 9 and smallest being 5

# Question 3
# displays a random floating point value between the ranges specified.
# lowest is 2.5 highest is 5.5
